-- =====================================================
-- REVENUE MODEL UPDATE: Platform Fee 10%
-- =====================================================

-- 1. Update the secure booking function with 10% platform fee
...
BEGIN
  ...
  v_platform_fee := ROUND(v_calculated_price * v_platform_fee_percentage, 2);
